...
// ═══════════════════════════════════════════════════════════════════════════
// Màu sắc cho các đường kẻ connection của con cái (Step 1)
// ═══════════════════════════════════════════════════════════════════════════

// Danh sách các màu cố định cho bà vợ 1, 2, n...
// Bạn có thể thay đổi các mã hex này theo ý muốn.
const POLYGAMY_COLORS = [
  "#ef4444", // Bà 1: Màu đỏ (red-500)
  "#22c55e", // Bà 2: Màu xanh lá cây (green-500)
  "#3b82f6", // Bà 3: Màu xanh dương (blue-500)
  "#a855f7", // Bà 4: Màu tím (purple-500)
  "#f97316", // Bà 5: Màu cam (orange-500)
  "#eab308", // Bà 6: Màu vàng (yellow-500)
];

// Hàm lấy màu xoay vòng dựa trên số thứ tự của bà vợ
function getWifeColor(wifeIndex: number): string {
  // wifeIndex bắt đầu từ 0
  if (wifeIndex < 0) return "#9ca3af"; // Mặc định (xám) nếu lỗi dữ liệu
  return POLYGAMY_COLORS[wifeIndex % POLYGAMY_COLORS.length];
}
